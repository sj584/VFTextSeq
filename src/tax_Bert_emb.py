...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate BERT embeddings from CSV")
    parser.add_argument("--input_csv", help="Path to input CSV file (e.g., alnRes_lca.csv)")
